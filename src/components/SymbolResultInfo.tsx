...
const SymbolResultInfo: FC<SymbolResultInfoProps> = ({ text }) => {
                ...
                <div className='space-y-6'>
                    ...
                    <div className='flex items-center justify-between'>
                        <div>
                            ...
                            <p className='text-sm text-gray-500 mt-1'>
                                80% failed to close above 9 EMA
                            </p>
                        </div>
                        <span className='px-3 py-1 text-sm font-medium rounded-full bg-red-50 text-red-700'>
                            Strong Resistance
                    ...
                    <div className='flex space-x-4 p-4 rounded-lg bg-gray-50'>
                        ...
                        <div className='flex-1'>
                            <p className='text-sm text-yellow-600'>
                                Price rejected at 9EMA level with increased
                                volume. Watch for potential continuation of
                                downward movement.
                            </p>
                        </div>
                    </div>
                    <div className='flex space-x-4 p-4 rounded-lg bg-gray-50'>
                        ...
                        <div className='flex-1'>
                            <p className='text-sm text-red-600'>
                                Strong bearish pressure continues. Price action
                                remains below VWAP with 80% of candles failing
                                to close above 9EMA.
                            </p>
                        </div>
                    </div>
